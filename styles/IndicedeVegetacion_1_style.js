...
var style_IndicedeVegetacion_1 = function(feature, resolution){
    ...
    if (value >= 0.128291 && value <= 0.197779) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.197779 && value <= 0.267268) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.267268 && value <= 0.336757) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.336757 && value <= 0.406246) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.406246 && value <= 0.475735) {
            style = [ new ol.style.Style({
